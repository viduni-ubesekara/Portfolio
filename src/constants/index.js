...
const experience = [
...

  {
   ...
   icon: bluechip,
    ...
    details: ["Worked closely with cross-functional teams to support business processes through documentation, analysis, and creative design. Gained hands-on experience with tools like Microsoft Office for reports, Figma for UI/UX mockups, and created engaging video content for internal use. Contributed to preparing business documents, presentations, and workflow diagrams to support decision-making and communication.",
    ],
    techs: [
      "Figma",
      "MS Office",
